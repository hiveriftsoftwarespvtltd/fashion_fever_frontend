...
const Footer = () => {
  ...
  return (
    <footer className={`pt-20 pb-10 border-t transition-colors duration-300 font-outfit ${
      isDarkMode 
        ? 'bg-gray-950 border-white/5 text-gray-400' 
      ...
      <div className="container mx-auto px-4 max-w-[1600px]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6 text-left">
            ...
            <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-550'}`}>
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href="#" className={`p-2.5 rounded-xl transition-all ${isDarkMode ? 'bg-white/5 text-gray-400 hover:text-primary' : 'bg-gray-50 text-gray-500 hover:text-primary'}`}>
          ...
          <div className="text-left">
            <h4 className={`text-base font-bold uppercase tracking-wider mb-8 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
              Discover
            </h4>
          ...
          <div className="text-left">
            ...
            <ul className="flex flex-col gap-6 text-sm">
              <li className="flex items-start gap-4">
                ...
                <span className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>WakeUp MakeUp Plaza, Bandra West, Mumbai, MH 400050</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="text-primary flex-shrink-0"><Phone size={18} /></div>
                <span className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>+91 99999 88888</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="text-primary flex-shrink-0"><Mail size={18} /></div>
                <span className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>support@wakeupmakeup.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Footer Bottom */}
        <div className={`pt-10 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-bold uppercase tracking-wider ${
