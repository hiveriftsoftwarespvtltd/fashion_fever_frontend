 ...
 <div className="bg-gray-50 min-h-screen py-12">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
   ...
   <div className="lg:col-span-1 space-y-6">
    ...
    <button className="w-full py-4 border-2 border-primary/10 text-primary font-bold uppercase text-[10px] rounded-xl hover:bg-primary/5 transition-all">Share Referral Link</button>
    </div>
   </div>
   ...
   <div className="lg:col-span-2 space-y-8">
    ...
    <button className="w-full mt-10 py-5 bg-gray-50 text-gray-400 font-bold uppercase text-[10px] rounded-[1.5rem] hover:bg-gray-100 hover:text-primary transition-all flex items-center justify-center gap-2">
