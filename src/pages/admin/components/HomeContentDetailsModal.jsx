        ...
        <div className="p-5 md:p-8 max-h-[90vh] overflow-y-auto">
          ...
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center gap-3">
              ...
              <span className="text-[10px] font-bold tracking-widest text-gray-400 uppercase">Synchronizing parameters...</span>
            </div>
          ) : data ? (
            <div className="space-y-6 text-left">
                ...
                <div className="space-y-1">
                  ...
                  <div className={`aspect-[2/1] rounded-2xl overflow-hidden border flex items-center justify-center bg-gray-50 dark:bg-gray-900 ${isDarkMode ? 'border-gray-750' : 'border-gray-100 shadow-sm'}`}>
                    {data.computerImage ? (
                      ...
                      <span className="text-[10px] font-bold text-gray-400 uppercase">No Desktop Image</span>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className={`aspect-[2/1] rounded-2xl overflow-hidden border flex items-center justify-center bg-gray-50 dark:bg-gray-900 ${isDarkMode ? 'border-gray-750' : 'border-gray-100 shadow-sm'}`}>
                    {data.mobileImage ? (
                      ...
                      <span className="text-[10px] font-bold text-gray-400 uppercase">No Mobile Image</span>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2.5">
                ...
                <span className={`px-3 py-1 rounded-xl text-[10px] font-black uppercase tracking-wider flex items-center gap-1.5 ${isDarkMode ? 'bg-gray-900 text-gray-300' : 'bg-gray-50 text-gray-600'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gray-900 border-white/5' : 'bg-gray-50 border-gray-100'} space-y-3`}>
                  <div>
                    <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Title Text</h4>
                    <p className={`text-sm font-black mt-0.5 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{data.title || '—'}</p>
                  </div>
                  <div>
                    <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Sub Title Text</h4>
                    <p className={`text-xs font-semibold mt-0.5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>{data.subTitle || '—'}</p>
                  </div>
                  {data.buttonText && (
                    <div>
                      <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Button CTA</h4>
                      <span className="inline-block px-3 py-1 mt-1 rounded-lg bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-[10px] font-black uppercase">
                        {data.buttonText}
                      </span>
                    </div>
                  )}
                ...
                <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gray-900 border-white/5' : 'bg-gray-50 border-gray-100'} space-y-3`}>
                  <div>
                    <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Redirect Type</h4>
                    <span className="inline-block px-2.5 py-0.5 mt-1 rounded-md bg-primary/10 text-primary text-[10px] font-black uppercase">
                      {data.redirectType || 'NONE'}
                    </span>
                  </div>
                  {data.redirectId && (
                    <div>
                      <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Target ObjectId</h4>
                      <code className="block text-[10px] font-bold text-gray-400 mt-0.5 select-all">{data.redirectId}</code>
                    </div>
                  )}
                  {data.redirectUrl && (
                    <div>
                      <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">External Destination URL</h4>
                      <a href={data.redirectUrl} target="_blank" rel="noreferrer" className="block text-[10px] font-bold text-primary hover:underline mt-0.5 truncate max-w-full">
                        {data.redirectUrl}
                      </a>
                    </div>
                  )}
                ...
                <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gray-900 border-white/5' : 'bg-gray-50 border-gray-100'} space-y-3`}>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-3 flex-1 min-w-0">
                      <div>
                        <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Publish Date</h4>
                        <p className={`text-xs font-bold mt-0.5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                          {formatDate(data.startDate)}
                        </p>
                      </div>
                      <div>
                        <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Expiration Date</h4>
                        <p className={`text-xs font-bold mt-0.5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                ...
                <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gray-900 border-white/5' : 'bg-gray-50 border-gray-100'} space-y-3`}>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-3 flex-1 min-w-0">
                      <div>
                        <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Background Color</h4>
                      ...
                      <div>
                        <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider">Text Color</h4>
                        <div className="flex items-center gap-2 mt-1">
              ...
              {data.labels && data.labels.length > 0 && (
                <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gray-900 border-white/5' : 'bg-gray-50 border-gray-100'}`}>
                  <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider mb-2 flex items-center gap-1.5">
              ...
              {data.description && (
                <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gray-900 border-white/5' : 'bg-gray-50 border-gray-100'}`}>
                  <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-wider mb-1.5">Description Overview</h4>
            ...
            <div className="py-20 flex flex-col items-center justify-center gap-2 text-rose-500">
              ...
              <span className="text-[10px] text-gray-400 uppercase font-medium">Could not fetch banner attributes</span>
            </div>
          )}
